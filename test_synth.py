...
'''
-call every track with x_
-clean at the beginning
-create a single script
-add costants for the names of ip / port /sushi proto
-add submodule git 
'''
...
sushi.audio_graph.create_processor_on_track('mda_jx10', None, '/home/mind/plugins/mda-vst2/mdaJX10.so',
                                            PluginType.VST2X, cimil_id, None, True)
